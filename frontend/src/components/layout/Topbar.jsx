...
const PATH_TITLES = [
	...
	{ test: (p) => p === '/driver',                                 title: 'My Assignment' },
	{ test: (p) => p === '/driver/my-tasks',                        title: 'My Tasks' },
	{ test: (p) => p === '/driver/pickup',                          title: 'Pickup Details' },
	{ test: (p) => p === '/driver/navigate',                        title: 'Navigation' },
	{ test: (p) => p === '/driver/alerts',                          title: 'Alerts' },
	{ test: (p) => p.includes('/driver/status'),                    title: 'Status Update' },
	{ test: (p) => p.includes('/driver/route-change'),              title: 'Route Change Alert' },
	{ test: (p) => p === '/receiver',                               title: 'Incoming Shipments' },
	{ test: (p) => p === '/receiver/create-order',                  title: 'Create Order' },
	{ test: (p) => p === '/receiver/track',                         title: 'Track Shipment' },
